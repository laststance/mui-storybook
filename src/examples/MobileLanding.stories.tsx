...
const features = [
  { icon: <SpeedIcon />, title: 'Lightning Fast', description: 'Optimized for speed with sub-second load times' },
  { icon: <SecurityIcon />, title: 'Secure by Default', description: 'End-to-end encryption for all your data' },
  { icon: <CloudIcon />, title: 'Cloud Sync', description: 'Access your data anywhere, anytime' },
  { icon: <PhoneIphoneIcon />, title: 'Mobile First', description: 'Designed for the best mobile experience' },
]

const testimonials = [
  { name: 'Sarah Johnson', role: 'Product Manager', rating: 5, comment: 'This app has transformed how our team works!' },
  { name: 'Mike Chen', role: 'Developer', rating: 5, comment: 'Best developer experience I\'ve ever had.' },
  { name: 'Emily Davis', role: 'Designer', rating: 4, comment: 'Beautiful UI and intuitive to use.' },
]

const pricingPlans = [
  { name: 'Free', price: 0, features: ['5 Projects', '1GB Storage', 'Basic Support'] },
  { name: 'Pro', price: 19, features: ['Unlimited Projects', '100GB Storage', 'Priority Support', 'Advanced Analytics'], popular: true },
  { name: 'Enterprise', price: 49, features: ['Everything in Pro', 'Custom Integrations', 'Dedicated Support', 'SLA'] },
]

const faqs = [
  { question: 'How do I get started?', answer: 'Simply download the app from the App Store or Google Play, create an account, and you\'re ready to go!' },
        ...
        <Box sx={{ bgcolor: 'grey.900', color: 'grey.400', py: 4 }}>
          <Container>
            ...
            <Stack direction="row" justifyContent="center" spacing={2} sx={{ mt: 2 }}>
              <Button size="small" sx={{ color: 'grey.400' }}>Privacy</Button>
              <Button size="small" sx={{ color: 'grey.400' }}>Terms</Button>
              <Button size="small" sx={{ color: 'grey.400' }}>Contact</Button>
            </Stack>
          </Container>
        </Box>
