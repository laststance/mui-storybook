...
const paymentMethods: PaymentMethod[] = [
  ...
  { id: '2', type: 'card', name: 'Mastercard', last4: '8888', expiry: '08/26', isDefault: false },
  { id: '3', type: 'bank', name: 'Chase Bank', last4: '1234', isDefault: false },
]

const transactions = [
  { id: 'TXN001', date: '2024-01-15', description: 'Premium Subscription', amount: -29.99, status: 'completed' },
  { id: 'TXN002', date: '2024-01-12', description: 'Refund - Order #1234', amount: 15.00, status: 'completed' },
  { id: 'TXN003', date: '2024-01-10', description: 'Pro Plan Upgrade', amount: -99.00, status: 'completed' },
  { id: 'TXN004', date: '2024-01-08', description: 'API Credits', amount: -50.00, status: 'pending' },
  { id: 'TXN005', date: '2024-01-05', description: 'Initial Deposit', amount: 200.00, status: 'completed' },
]
      ...
      <Container maxWidth="lg">
        <Box sx={{ py: 3 }}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
            Manage your payment methods, view transactions, and update billing settings.
          </Typography>
                    ...
                    <List>
                      {paymentMethods.map((method, index) => (
                        <Box key={method.id}>
                          ...
                          <ListItem sx={{ py: 2 }}>
                            <ListItemAvatar>
                              <Avatar sx={{ bgcolor: method.type === 'card' ? 'primary.main' : 'success.main' }}>
                                {method.type === 'card' ? <CreditCardIcon /> : <AccountBalanceIcon />}
                              </Avatar>
                            </ListItemAvatar>
                            <ListItemText
                              primary={
              ...
              <Grid size={{ xs: 12, md: 4 }}>
                <Card sx={{ bgcolor: 'primary.main', color: 'white', mb: 2 }}>
                  <CardContent>
                    ...
                    <Typography variant="h3" sx={{ my: 1 }}>$136.01</Typography>
                ...
                <Card>
                  <CardContent>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                      <Typography variant="body2" color="text.secondary">Pro Plan</Typography>
                      <Typography variant="body2">$29.99/mo</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                      <Typography variant="body2" color="text.secondary">API Credits</Typography>
                      <Typography variant="body2">$50.00</Typography>
                    </Box>
                    <Divider sx={{ my: 1 }} />
                    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      <Typography variant="subtitle1">Total</Typography>
                      <Typography variant="subtitle1" sx={{ fontWeight: 'bold' }}>$79.99</Typography>
                    </Box>
                  </CardContent>
                </Card>
              </Grid>
                ...
                <List>
                  {transactions.map((txn, index) => (
                    <Box key={txn.id}>
                      ...
                      <ListItem sx={{ py: 2 }}>
                        <ListItemAvatar>
                          <Avatar sx={{ bgcolor: txn.amount > 0 ? 'success.light' : 'grey.200' }}>
                            <ReceiptIcon color={txn.amount > 0 ? 'success' : 'action'} />
                          </Avatar>
                        </ListItemAvatar>
                        <ListItemText
              ...
              {activeStep === 0 && (
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 2 }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 2 }}>
                    <TextField label="Expiry Date" placeholder="MM/YY" sx={{ flex: 1 }} />
              ...
              {activeStep === 2 && (
                <Box sx={{ mt: 2 }}>
                  ...
                  <Paper variant="outlined" sx={{ p: 2 }}>
                    <Typography variant="subtitle2" color="text.secondary">Card Details</Typography>
