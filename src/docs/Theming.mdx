...
|----------|-------------|
| **Single Theme** | Create one theme and extend as needed |
| **Use Tokens** | Reference theme values instead of hardcoding |
| **Type Safety** | Extend theme types for custom properties |
| **Performance** | Memoize theme creation with `useMemo` |
| **Consistency** | Use `sx` prop for one-off styles |
