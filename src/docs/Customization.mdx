...
|--------|-------|----------|
| `sx` prop | Single instance | One-off styles |
| `styled()` | Reusable component | Shared styled variants |
| Theme `styleOverrides` | All instances | Global defaults |
| Theme `variants` | Conditional | New variant types |
| CSS Variables | Runtime | Dynamic theming |
...
| Practice | Do | Don't |
|----------|----|----- |
| **One-off styles** | Use `sx` prop | Create new styled component |
| **Reusable styles** | Use `styled()` | Duplicate `sx` props |
| **Global defaults** | Use theme overrides | Override in every instance |
| **Custom variants** | Use theme variants | Create wrapper components |
| **CSS specificity** | Use MUI APIs | Use `!important` |
